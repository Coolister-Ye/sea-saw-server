# sea_saw_crm/views/payment_view.py
...
from ..mixins.payment_mixin import (
...
class NestedPaymentViewSet(
    ...
    Usage:
    - Create Order Payment: POST /api/sea-saw-crm/nested-payments/?order=123
    - Create Purchase Payment: POST /api/sea-saw-crm/nested-payments/?purchase_order=456
    - Create Production Payment: POST /api/sea-saw-crm/nested-payments/?production_order=789
    - Create Outbound Payment: POST /api/sea-saw-crm/nested-payments/?outbound_order=321
    - Update: PATCH /api/sea-saw-crm/nested-payments/999/?order=123
